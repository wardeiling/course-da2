...
```{r}
places <- read.table("practical_03/places.txt", header = FALSE)
```
...
```{r}
stocks <- read.table("practical_03/close_stocks.dat", header = TRUE, sep = "\t")
```
...
```{r}
author <- read.table("practical_03/author.txt", header = TRUE)
...
```{r}
indian_sm <- read.table("practical_03/IndianSM.txt", header = TRUE)
...
```{r}
volume_data <- read.table("practical_03/volume_stocks.dat", header = TRUE, sep = "\t")
...
```{r}
benthos <- read.table("practical_03/benthos.txt", header = TRUE)
