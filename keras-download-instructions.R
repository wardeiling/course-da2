...
# Also, it may be necessary to run Rstudio as administrator.
...
install_keras(
  envname = "r-keras",
  backend = c("tensorflow"),
  gpu = FALSE, # with GPU it may be more prone to failure as it requires additional installations
