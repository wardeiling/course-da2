...
Feature selection methods essentially remove some features from the data, whereas feature extraction takes/extracts useful bits of information from the input features by transforming them into something more useful (e.g., principal components, independent components).
